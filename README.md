...
```
$ git clone https://github.com/MelissaData/PresortObject-Python3.git
...
2.  If you already have the latest DQS Release (ZIP), you can find the data file(s) and dll(s) in there
	...
	- Copy all the dll(s) mentioned above into the `MelissaPresortObjectWindowsPython3` project folder.
