# Name:    MelissaPresortObjectWindowsPython3
# Purpose: Use the Melissa Updater to make the MelissaPresortObjectWindowsPython3 code usable
...
function CheckDLLs() {
  ...
  $FileMissing = $false 
  if (!(Test-Path (Join-Path -Path $ProjectPath -ChildPath "mdPresort.dll"))) {
...
Write-Host "`n====================== Melissa Presort Object ======================`n                    [ Python3 | Windows | 64BIT ]`n"
